...
function PANEL:PerformLayout(width, height)
	surface.SetFont("ixCaptureCharSelFont")
...
function PANEL:Init()
	...
	self.textEntry:SetFont("ixCaptureCharSelFont")
...
function PANEL:Init()
	...
	self.setting:Dock(RIGHT)
	self.setting:SetFont("ixCaptureCharSelFont")
...
function PANEL:Init()
	...
	self.text:Dock(LEFT)
	self.text:SetFont("ixCaptureCharSelFont")

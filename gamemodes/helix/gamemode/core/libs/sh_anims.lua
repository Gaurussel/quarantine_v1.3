...
ix.anim.citizen_male = {
	normal = {
		[ACT_MP_STAND_IDLE] = {ACT_IDLE, "idle_fist"},
		[ACT_MP_CROUCH_IDLE] = {ACT_COVER_LOW, "cidle_fist"},
		[ACT_MP_WALK] = {ACT_WALK, "walk_fist"},
		[ACT_MP_CROUCHWALK] = {ACT_WALK_CROUCH, "cwalk_fist"},
		[ACT_MP_RUN] = {ACT_RUN, "run_fist"},
		[ACT_LAND] = {ACT_RESET, "jump_fist"},
	...
	pistol = {
		...
		[ACT_MP_WALK] = {ACT_WALK, "walk_pistol"},
		[ACT_MP_CROUCHWALK] = {ACT_WALK_CROUCH, ACT_WALK_CROUCH_AIM_RIFLE},
		[ACT_MP_RUN] = {ACT_RUN, "run_pistol"},
	...
	glide = ACT_GLIDE,
	vehicle = {
		["prop_vehicle_prisoner_pod"] = {ACT_BUSY_SIT_CHAIR, Vector(-3, 0, 0)},
...
ix.anim.SetModelClass("models/severance/ceda/ceda_operator1.mdl", "citizen_male")
ix.anim.SetModelClass("models/severance/ceda/ceda_operator2.mdl", "citizen_male")
ix.anim.SetModelClass("models/kake/ceda_operator_female.mdl", "citizen_female")
ix.anim.SetModelClass("models/kake/gasmask_female/gasmask_female.mdl", "citizen_female")
ix.anim.SetModelClass("models/bloocobalt/splinter cell/chemsuit_cod2.mdl", "citizen_male")
ix.anim.SetModelClass("models/infection/female_01.mdl", "citizen_female")
ix.anim.SetModelClass("models/infection/female_02.mdl", "citizen_female")
ix.anim.SetModelClass("models/infection/female_03.mdl", "citizen_female")
ix.anim.SetModelClass("models/infection/female_04.mdl", "citizen_female")
ix.anim.SetModelClass("models/infection/female_06.mdl", "citizen_female")
ix.anim.SetModelClass("models/infection/female_07.mdl", "citizen_female")
ix.anim.SetModelClass("models/infection/male_01.mdl", "citizen_male")
ix.anim.SetModelClass("models/infection/male_02.mdl", "citizen_male")
ix.anim.SetModelClass("models/infection/male_03.mdl", "citizen_male")
ix.anim.SetModelClass("models/infection/male_04.mdl", "citizen_male")
ix.anim.SetModelClass("models/infection/male_05.mdl", "citizen_male")
ix.anim.SetModelClass("models/infection/male_06.mdl", "citizen_male")
ix.anim.SetModelClass("models/infection/male_07.mdl", "citizen_male")
ix.anim.SetModelClass("models/infection/male_08.mdl", "citizen_male")
ix.anim.SetModelClass("models/infection/male_09.mdl", "citizen_male")
ix.anim.SetModelClass("models/player/hazmat/hazmat1980_npc.mdl", "citizen_male2")

...
ITEM.name = "Записка"
ITEM.description = "Записка, %s."
ITEM.price = 2
ITEM.model = Model("models/props/unicupon.mdl")
ITEM.width = 1
ITEM.height = 1
...
function ITEM:GetDescription()
	return self:GetData("owner", 0) == 0
		and string.format(self.description, "она вся в лохмотьях и грязи.")
		or string.format(self.description, "на ней написано..")
end

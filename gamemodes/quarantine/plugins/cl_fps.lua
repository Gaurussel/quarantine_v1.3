...
if (CLIENT) then
	...
	hook.Add("OnEntityCreated", "QR.DisableShadows", function(entity)
		if (ix.option.Get("entityShadows", false)) then
			entity:DrawShadow(false)
		end
	end)

	hook.Add("InitPostEntity", "QR.DisableShadows", function()
		if (ix.option.Get("entityShadows", false)) then
...
if (SERVER) then
	hook.Add("PropBreak", "QR.AntiConstraintCrash", function(attacker, ent)

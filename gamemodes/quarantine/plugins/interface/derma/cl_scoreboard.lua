...
function PANEL:Update()
	...
	local description = client:GetCharacter():GetDescription()

	if client:GetNetVar("adminmode", false) then
		name = name.." ★"
	end

	local bRecognize = true
...
hook.Add("CreateMenuButtons", "ixScoreboard", function(tabs)
	if LocalPlayer():IsAdmin() or LocalPlayer():GetUserGroup() == "operator" or LocalPlayer():GetUserGroup() == "moderator" then

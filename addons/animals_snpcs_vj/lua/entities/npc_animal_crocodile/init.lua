...
-----------------------------------------------*/
ENT.Model = "models/animals/crocodile.mdl" 
ENT.StartHealth = GetConVarNumber("vj_crocodile_h")
...
ENT.TimeUntilMeleeAttackDamage = 1.1 -- This counted in seconds | This calculates the time until it hits something
ENT.NextAnyAttackTime_Melee = 0.7 -- How much time until it can use a attack again? | Counted in Seconds
ENT.MeleeAttackDamage = GetConVarNumber("vj_crocodile_d")
...
ENT.SoundTbl_Idle = {"crocodile/idle1.wav"}
ENT.SoundTbl_Alert = {"crocodile/idle1.wav"}
ENT.SoundTbl_MeleeAttack = {"npc/antlion_guard/foot_heavy1.wav"}
ENT.SoundTbl_MeleeAttackMiss = {""}
ENT.SoundTbl_Pain = {"crocodile/idle1.wav"}
ENT.SoundTbl_Death = {""}

---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:CustomInitialize()
	self:SetCollisionBounds(Vector(130, 25 , 60), Vector(-100, -25, 0))
...
function ENT:CreateDeathCorpse(dmginfo,hitgroup)	
	...
	gib:SetModel( "models/animal_ragd/piratecat_crocodile.mdl" )

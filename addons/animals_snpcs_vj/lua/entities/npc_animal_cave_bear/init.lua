...
ENT.StartHealth = GetConVarNumber("vj_bear_h")
ENT.MoveType = MOVETYPE_STEP
ENT.HullType = HULL_LARGE
---------------------------------------------------------------------------------------------------------------------------------------------
ENT.Behavior = VJ_BEHAVIOR_AGGRESSIVE
ENT.VJ_FriendlyNPCsSingle = {"npc_animal_bear","npc_animal_cave_bear"}
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_bear_d")

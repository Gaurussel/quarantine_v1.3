...
-----------------------------------------------*/
ENT.Model = "models/animals/monkey.mdl" 
ENT.StartHealth = GetConVarNumber("vj_monkey_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_monkey_d")
...
ENT.SoundTbl_Idle = {"monkey/idle1.wav"}
ENT.SoundTbl_Alert = {"monkey/hurt.wav"}
ENT.SoundTbl_MeleeAttack = {"monkey/hurt.wav"}
ENT.SoundTbl_MeleeAttackMiss = {}
ENT.SoundTbl_Pain = {"monkey/hurt.wav"}
ENT.SoundTbl_Death = {""}

function ENT:CustomInitialize()
	self:SetCollisionBounds(Vector(25, 10 , 50), Vector(-25, -10, 0))
	...
	gib:SetModel( "models/animal_ragd/piratecat_monkey.mdl" )
	gib:SetModelScale(0.5)

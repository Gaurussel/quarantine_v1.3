...
-----------------------------------------------*/
ENT.Model = "models/animals/jaguar.mdl" 
ENT.StartHealth = GetConVarNumber("vj_jaguar_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_jaguar_d")
...
ENT.SoundTbl_Idle = {"jaguar/idle1.wav"}
ENT.SoundTbl_Alert = {"jaguar/attack1.wav"}
ENT.SoundTbl_MeleeAttack = {"jaguar/attack1.wav"}
ENT.SoundTbl_MeleeAttackMiss = {}
ENT.SoundTbl_Pain = {"jaguar/attack1.wav"}
ENT.SoundTbl_Death = {""}
...
function ENT:CustomInitialize()
	...
	gib:SetModel( "models/animal_ragd/piratecat_jaguar.mdl" )

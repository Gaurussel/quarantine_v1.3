...
-----------------------------------------------*/
ENT.Model = "models/animals/rhino.mdl" 
ENT.StartHealth = GetConVarNumber("vj_rhino_h")
...
ENT.MeleeAttackDamageDistance = 250 -- How far the damage goes
...
ENT.NextAnyAttackTime_Melee = 0.9 -- How much time until it can use a attack again? | Counted in Seconds
ENT.MeleeAttackDamage = GetConVarNumber("vj_rhino_d")
ENT.HasExtraMeleeAttackSounds = true-- Set to true to use the extra melee attack sounds
ENT.HasMeleeAttackKnockBack = true -- If true, it will cause a knockback to its enemy
ENT.MeleeAttackKnockBack_Forward1 = 800
ENT.MeleeAttackKnockBack_Forward2 = 800
ENT.MeleeAttackKnockBack_Up1 = 250 
ENT.MeleeAttackKnockBack_Up2 = 250-- Knockback Up Number
...
ENT.SoundTbl_Idle = {"rhino/idle1.wav"}
ENT.SoundTbl_MeleeAttack = {"npc/antlion_guard/shove1.wav"}
ENT.SoundTbl_Alert = {"rhino/idle1.wav"}
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:CustomInitialize()
	self:SetCollisionBounds(Vector(100, 18, 110), Vector(-50, -18, 0))
end
...
function ENT:MultipleMeleeAttacks()
	...
	if attack == 1 then
		...
		self.MeleeAttackDistance = 65
		self.MeleeAttackDamageDistance = 250
		self.TimeUntilMeleeAttackDamage = 1.5
		self.NextAnyAttackTime_Melee = 0.9
		self.MeleeAttackDamage = GetConVarNumber("vj_rhino_d")
		self.MeleeAttackDamageType = DMG_SLASH
		self.MeleeAttackKnockBack_Forward1 = 800
		self.MeleeAttackKnockBack_Forward2 = 800

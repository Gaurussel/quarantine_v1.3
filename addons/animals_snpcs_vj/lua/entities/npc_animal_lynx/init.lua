...
-----------------------------------------------*/
ENT.Model = "models/animals/lynx.mdl" 
ENT.StartHealth = GetConVarNumber("vj_lynx_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_lynx_d")
...
ENT.SoundTbl_Alert = {"lynx/idle_inactive.wav"}
...
function ENT:CustomInitialize()
	self:SetCollisionBounds(Vector(35, 5 , 40), Vector(-35, -5, 0))
	...
	gib:SetModel( "models/animal_ragd/piratecat_lynx.mdl" )

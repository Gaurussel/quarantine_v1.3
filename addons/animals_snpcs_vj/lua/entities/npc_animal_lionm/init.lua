...
-----------------------------------------------*/
ENT.Model = "models/animals/lionm.mdl" 
ENT.StartHealth = GetConVarNumber("vj_lion_h")
...
ENT.TimeUntilMeleeAttackDamage = 1.8 -- This counted in seconds | This calculates the time until it hits something
ENT.NextAnyAttackTime_Melee = 0.3 -- How much time until it can use a attack again? | Counted in Seconds
ENT.MeleeAttackDamage = GetConVarNumber("vj_lion_d")
...
function ENT:CreateDeathCorpse(dmginfo,hitgroup)	
	...
	gib:SetModel( "models/animal_ragd/piratecat_lionm.mdl" )

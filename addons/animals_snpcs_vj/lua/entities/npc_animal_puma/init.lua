...
-----------------------------------------------*/
ENT.Model = "models/animals/puma.mdl" 
ENT.StartHealth = GetConVarNumber("vj_puma_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_puma_d")
...
ENT.SoundTbl_Idle = {"puma/idle1.wav"}
ENT.SoundTbl_Alert = {"puma/attack1.wav"}
ENT.SoundTbl_MeleeAttack = {"puma/attack1.wav"}
ENT.SoundTbl_MeleeAttackMiss = {}
ENT.SoundTbl_Pain = {"puma/attack1.wav"}
ENT.SoundTbl_Death = {""}


function ENT:CustomInitialize()
	self:SetCollisionBounds(Vector(55, 5 , 90), Vector(-35, -5, 0))
	...
	gib:SetModel( "models/animal_ragd/piratecat_puma.mdl" )

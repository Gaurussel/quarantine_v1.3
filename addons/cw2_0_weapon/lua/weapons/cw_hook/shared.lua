...
if CLIENT then
	...
	SWEP.WM = "models/weapons/HL2meleepack/w_hook.mdl"
...
SWEP.PlayerHitSounds = {"Flesh.Break"}
...
SWEP.PrimaryAttackDelay = 1.2
SWEP.SecondaryAttackDelay = 2

SWEP.PrimaryAttackDamage = {34, 55}
SWEP.SecondaryAttackDamage = {34, 55}

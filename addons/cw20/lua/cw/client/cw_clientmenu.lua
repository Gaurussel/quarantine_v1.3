...
CustomizableWeaponry.renderTargetSizes = {
	[1] = {size = 256, text = "Low (256x256)"},
...
local function CW2_ClientsidePanel(panel)
	...
	slider:SetValue(GetConVar("cw_freeaim_autocenter_time"):GetInt())
	...
	slider:SetValue(GetConVar("cw_freeaim_center_mouse_impendance"):GetInt())
	...
	slider:SetValue(GetConVar("cw_freeaim_lazyaim"):GetInt())
	...
	slider:SetValue(GetConVar("cw_freeaim_pitchlimit"):GetInt())
	...
	slider:SetValue(GetConVar("cw_freeaim_yawlimit"):GetInt())
	...
	laserQ:SetText("Laser quality:" .. CW2_GetLaserQualityText(GetConVar("cw_laser_quality"):GetInt()))
	laserQ.ConVar = "cw_laser_quality"

	laserQ:AddChoice("Normal")
	laserQ:AddChoice("High")

	laserQ.OnSelect = function(_, index, value, data)
	...
	rtScope:SetText("RT scope quality: " .. CustomizableWeaponry:getRenderTargetText(GetConVar("cw_rt_scope_quality"):GetInt()))
	...
	rtScope.OnSelect = function(_, index, value, data)
		index = tonumber(index)

		rtScope:SetText("RT scope quality: " .. CustomizableWeaponry:getRenderTargetText(index))
		local prevQuality = GetConVar(rtScope.ConVar):GetInt()

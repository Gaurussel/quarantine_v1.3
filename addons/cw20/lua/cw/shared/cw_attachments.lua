...
CustomizableWeaponry.textColors = {
	POSITIVE = Color(200, 255, 200, 255),
...
do
	...
	for _, v in pairs(file.Find("cw/shared/attachments/*", "LUA")) do
		CustomizableWeaponry.loadFile(path .. v)
	end
end
...
do
	...
	for _, v in pairs(file.Find("cw/shared/ammotypes/*", "LUA")) do
		CustomizableWeaponry.loadFile(path .. v)
	end
end